...
{
    public abstract class ThueDatWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ThueDatWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ThueDatWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ThueDatDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ThueDatDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ThueDatDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ThueDatDbContext, Task<T>> func)
        {
            T result;
